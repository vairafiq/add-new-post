...
Adds the missing "Add New" button of classic editor to the Block Editor toolbar, so you can easily create new posts/pages/custom post types, as well as duplicate or permanently delete post.

== Description ==

Gutenbergh Add New Post allow you to quickly create new posts from the Block Editor toolbar. You can create new posts in one of two ways:
...
* You can duplicate or completely delete the current post with two clicks.
...
3. Click the menu button to reveal the `Duplicate Post` and `Delete Permanently` buttons.
